...
INSERT INTO USERS(id, username, password, user_role, is_account_non_expired, is_account_non_locked,
                    is_credentials_non_expired, is_enabled)
VALUES (3, 'user1', '$2a$10$GRLdNijSQMUvl/au9ofL.eDwmoohzzS7.rmNSJZ.0FxO/BTk76klW', 'USER', true, true, true, true);

INSERT INTO USERS(id, username, password, user_role, is_account_non_expired, is_account_non_locked,
             is_credentials_non_expired, is_enabled)
VALUES (4, 'superadmin1', '$2a$10$GRLdNijSQMUvl/au9ofL.eDwmoohzzS7.rmNSJZ.0FxO/BTk76klW', 'SUPER_ADMIN', true, true, true, true);